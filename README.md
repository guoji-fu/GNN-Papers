# GNN-Papers
Awsome Papers on Graph Neural Networks (GNNs) with interesting theoretical analysis.
...
1. **p-Laplacian Based Graph Neural Networks.**
    ...
    - [paper](https://arxiv.org/pdf/2111.07337)
...
1. **Convergence of Invariant Graph Networks.**
    - ICML 2022.
    - *Chen Cai, Yusu Wang.*
    - [paper](https://arxiv.org/pdf/2201.10129.pdf)

1. **Generalization Guarantee of Training Graph Convolutional Networks with Graph Topology Sampling.**
    - <details><summary>Abstract</summary><p align = "justify"></p></details>
    - ICML 2022.
    - *Hongkang Li, Meng Wang, Sijia Liu, Pin-Yu Chen, Jinjun Xiong.*
    - [paper]()

1. **Probing GNN Explainers: A Rigorous Theoretical and Empirical Analysis of GNN Explanation Methods.**
    - AISTAT 2022.
    - *Chirag Agarwal, Marinka Zitnik, Himabindu Lakkaraju.*
    - [paper](https://arxiv.org/pdf/2106.09078.pdf)

1. **Stability and Generalization Capabilities of Message Passing Graph Neural Networks.**
    - arXiv 2022.
    - *Sohir Maskey, Yunseok Lee, Ron Levie, Gitta Kutyniok.*
    - [paper](https://arxiv.org/pdf/2202.00645.pdf)
...
1. **On Provable Benefits of Depth in Training Graph Convolutional Networks.**
    ...
    - [paper](https://arxiv.org/pdf/2110.15174)
...
1. **Expressiveness and Approximation Properties of Graph Neural Networks.**
    ...
    - [paper](https://openreview.net/pdf?id=wIzUeM3TAU)
...
1. **How Powerful are Spectral Graph Neural Networks.**
    ...
    - [paper](https://arxiv.org/pdf/2205.11172.pdf)

1. **On the Equivalence Between Temporal and Static Graph Representations for Observational Predictions.**
    - ICML 2022.
    - *Jianfei Gao, Bruno Ribeiro.*
    - [paper](https://arxiv.org/pdf/2103.07016.pdf)

1. **A Theoretical Comparison of Graph Neural Network Extensions.**
    - ICML 2022.
    - *Pál András Papp, Roger Wattenhofer.*
    - [paper](https://arxiv.org/pdf/2201.12884.pdf)

1. **The Exact Class of Graph Functions Generated by Graph Neural Networks.**
    - arXiv 2022.
    - *Mohammad Fereydounian, Hamed Hassani, Javid Dadashkarimi, Amin Karbasi.*
    - [paper](https://arxiv.org/pdf/2202.08833.pdf)

1. **Not Too Little, Not Too Much: a Theoretical Analysis of Graph (over)Smoothing.**
    - arXiv 2022.
    - *Nicolas Keriven.*
    - [paper](https://arxiv.org/pdf/2205.12156.pdf)

1. **Graph Neural Networks Are More Powerful Than We Think.**
    - arXiv 2022.
    - *Charilaos I. Kanatsoulis, Alejandro Ribeiro.*
    - [paper](https://arxiv.org/pdf/2205.09801.pdf)

1. **When Does A Spectral Graph Neural Network Fail in Node Classification?**
    - arXiv 2022.
    - *Zhixian Chen, Tengfei Ma, Yang Wang.*
    - [paper](https://arxiv.org/pdf/2202.07902.pdf)
